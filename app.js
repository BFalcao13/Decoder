...
let textOutput = document.querySelector('#mensagem__conteudo');
...
function resetContent() {
    textOutput.innerHTML = '<img src="./assets/ET.gif" alt="">' +
                           '<h1>Nenhuma mensagem encontrada</h1>' +
                           '<h3>Escreva uma palavra para codificar.</h3>';
}

function alert01(){
    alert('Escreva uma palavra para codificar');
}

function alert02(){
    alert('Escreva uma palavra para decodificar.');
}
